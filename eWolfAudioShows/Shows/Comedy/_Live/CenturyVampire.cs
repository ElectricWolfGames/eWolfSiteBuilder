...
namespace eWolfAudioShows.Shows.Comedy._Live
{
    public class CenturyVampire : AudioBaseDetails
    {
        public CenturyVampire()
        {
            ...
            Shows.Shows[0].AddEpisode(4, "Staff Outing", "Debbie is responsible for arranging the annual Co-op staff outing, and decides on a trip to donate blood.");
            Shows.Shows[0].AddEpisode(5, "Endangered Species", "Eloise and Lucretia discover that Mr Jenkins's blood is the rarest – and tastiest! – in the world.");
            Shows.Shows[0].AddEpisode(6, "Love Shack", "Left alone to castle-sit in Lucretia's absence, how far will Eloise let boyfriend Wayne go?");
        }
    }
}