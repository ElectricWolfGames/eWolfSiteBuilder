...
{
    public class Castle : AudioBaseDetails
    {
        public Castle()
        {
            ...
            Shows.Shows[0].AddEpisode(4, "Episodes 4", "Sir John decides to open a theme castle and Sam Tree decides to save Unicorn Forest. Meanwhile, Anne and Charlotte are looking out for flying sheep.");
            Shows.Shows[0].AddEpisode(5, "Episodes 5", "The village pub acquires two new mysterious barmaids as Anne and Charlotte plot to ensnare Sam Tree. De Warenne gets in touch with his feminine side whilst Duncan gets in touch with his masculine one.");
            ...
            Shows.Shows[1].AddEpisode(4, "Pool Party Of Doom", "A heatwave and an archaeological excavation leads to an unexpected swimming pool.");
            Shows.Shows[1].AddEpisode(5, "Be Sure To Wear Some Flowers In Your Visor", "Sir John decides to raise money by holding a rock festival in the grounds of Woodstock. Cue the sounds of the electric lute, new-fangled hummous from the Levant and much disapproval from Pope Innocent VI.");
            ...
            Shows.Shows[2].AddEpisode(4, "The Vuvuzela Of Terror", "An Englishman's home is his castle and an Englishman's moat is his tax write-off - until Sir John is investigated and has to hire some Frenchmen and a bucket of eels. Meanwhile, the Woodstock Hospital is about to lose its no-star status.");
            Shows.Shows[2].AddEpisode(5, "Four Wiseguys And A Funeral", "When some gangsters from De Warenne's past pay a little visit, Henry becomes a made man and Charlotte becomes an unmade woman. Plus a clever sting and a souped-up getaway sheep.");
            ...
            Shows.Shows[3].AddEpisode(4, "Boogie Knights", "The wedding of the decade is almost ruined by 200 tents and an over-excited woodpecker. Plus Henry, Duncan and De Warenne gatecrash a rather special hen night.");
            Shows.Shows[3].AddEpisode(5, "Give Me the Flaming Torch", "The Olympics are coming to Woodstock, so what better time for Sir William to go on a go-slow and for Henry to hunt for dragons? Meanwhile, Sir John tries to get fit.\r\n");
            Shows.Shows[3].AddEpisode(6, "A Term for the Worse", "Anne's off to Cambridge, but Charlotte doesn't know the meaning of the word 'thick'. Literally. Is this the end of a beautiful friendship?");
        }
    }
}