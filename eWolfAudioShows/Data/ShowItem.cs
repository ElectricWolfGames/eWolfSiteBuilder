...
public class ShowItem
    {
        ...
        public List<ShowEpisodeItem> Episodes { get; set; } = [];
        ...
        {
            var e = new ShowEpisodeItem(number, name, string.Empty, string.Empty, string.Empty);
            Episodes.Add(e);
        }

        internal void AddEpisode(int number, string name, string description)
        {
            var e = new ShowEpisodeItem(number, name, description, string.Empty, string.Empty);
            Episodes.Add(e);
        }

        internal void AddEpisode(int number, string name, string description, string mp3, string image)
        {
            var e = new ShowEpisodeItem(number, name, description, mp3, image);
            Episodes.Add(e);
        }
