...
public class Gush : AudioBaseDetailsOLD
{
    public Gush()
    {
        ...
        Casts.Add("Various", "Toby Longworth");
        Casts.Add("Various", "Mandy Knight");
        Casts.Add("Various", "Steve Steen");
        Casts.Add("Various", "John Whitehal");
