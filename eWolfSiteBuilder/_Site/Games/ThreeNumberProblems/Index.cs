...
namespace eWolfSiteBuilder._Site.Games.ThreeNumberProblems
{
    ...
    public class Index : PageDetailsWolfSite
    {
        ...
        public Index()
        {
            ...
            DisplayTitle = "Three Number Problem";
            MenuTitle = "Three Number Problem";
        ...
        public override void CreatePage()
        {
            ...
            WebPage.Append(CreateScreenShots());
        ...
        {
            section.ImagePath($"{ImageFolder}/{imageName}", 90);
