    ...
    public class BookEffectV2 : PageDetailsWolfSite
    {
        ...
        public PreviewItem GetHomePagePreview()
        {
            PreviewItem pi = new PreviewItem()
            {
                ...
                Description = "Lets you add a book with turning pages into any unity game. </br>" +
                "Just add the prefab book object and then add all of your textures in the Inspector. Just add the prefab.",
            };
        ...
        {
            HTMLBuilder options = new HTMLBuilder();
            options.Jumbotron(DisplayTitle + "(2023) Version", "Book effect lets you add a book to your scene with turning pages. And by using the interface you have actions to open, close the book and turn the pages forward and back. All pages are added to the Inspector as textures.");
            return options.Output();
        }
